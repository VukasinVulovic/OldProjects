 ...
 function rectangle(id='rectElement', width=200, height=100, x=50, y=50, z=0, color='#ff0000') {
 ...
 function circle(id='circleElement', size=100, x=50, y=50, z=1, color='#ff0000') {
 ...
 function pill(id='pillElement', width=100, height=100, round=25, x=50, y=50, z=2, color='#ff0000') {
 ...
 function addImage(id='image', source='https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/JavaScript-logo.png/64px-JavaScript-logo.png', x=0, y=0, width=100, height=100, style='default', e=noFunction) {
 ...
 function addText(id='basic', text='Test', size=80, color='#ff0000', x=0, y=0, align='-') {
 ...
 function fpsCounter() {
   ...
   function loopFps() {
     window.requestAnimationFrame(() => {
       ...
       times.push(now);
       fps = times.length;
       addText('fps_counterxx23', fps, 80, '#ff0000', window.innerWidth-100, 10, '-').style.opacity = 0.7;
