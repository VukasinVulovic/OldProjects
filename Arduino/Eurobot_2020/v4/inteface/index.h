...
<html lang='en' dir='ltr'>
  <head>
    ...
    <style type='text/css'>
      ...
      #W, #S, #A, #D, #stop { -webkit-user-select: none; background-color: #000000; padding: 1em 1.5em; text-decoration: none; text-transform: uppercase; color: #ffffff; position: absolute; border: none; }            
      #W { top: 0; }            
      #S { bottom: 0; }           
      #A { left: 0; top: 50%; }            
      #D { right: 0; top: 50%; }            
