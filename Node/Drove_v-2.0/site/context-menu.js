    ...
    container: [
        {
            ...
            f: (e) => {
                ...
                form.action = `/upload-file?username=${USER.username}&password=${USER.password}&url=${encodeURI(location.href)}`;
                form.onsubmit = () => {
    ...
    on_file: [
        {
            ...
            f: (e) => {
                ...
                open(`/downloadfile/${USER.username}/${url}${SELECTED.alt}/`, '_blank');
            }
        },
        // {
        //     name: 'Share file',
