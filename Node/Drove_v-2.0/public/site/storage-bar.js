function createBar(max, values) {
    ...
    storage_used.innerText = `${(used/1024).toFixed(3)}GB of ${(max/1024).toFixed(3)}GB Used`;
    ...
    storage_left.innerText = `${((max-used)/1024).toFixed(3)}GB Left`
    ...
    container.appendChild(storage_container);
}